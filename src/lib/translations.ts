...
export const es: Dict = {
  ...
  "Com a direção definida, usamos inteligência artificial para gerar e testar centenas de direções visuais em tempo recorde — ampliando o campo de possibilidades muito além do habitual.": "Con la dirección definida, usamos inteligencia artificial para generar y probar cientos de direcciones visuales en tiempo récord, ampliando el campo de posibilidades mucho más allá de lo habitual.",
...
export const en: Dict = {
  ...
  "Com a direção definida, usamos inteligência artificial para gerar e testar centenas de direções visuais em tempo recorde — ampliando o campo de possibilidades muito além do habitual.": "With the direction set, we use artificial intelligence to generate and test hundreds of visual directions in record time, widening the field of possibilities far beyond the usual.",
