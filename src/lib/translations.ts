...
export const es: Dict = {
  ...
  "Usamos IA para gerar centenas de direções visuais em tempo recorde.": "Usamos IA para generar cientos de direcciones visuales en tiempo récord.",
...
export const en: Dict = {
  ...
  "Usamos IA para gerar centenas de direções visuais em tempo recorde.": "We use AI to generate hundreds of visual directions in record time.",
